...
Code avec un ESP32 C6 , mais peut etre utilisé avec tout type d'ESP32 , il faut adapter le type de carte utilisée dans board:

Valable sur la plus part des electrolyseur ayant une entrée accessible en modbus : Racer , Ibiza , ...
...
La majorité des electrolyseurs ont une table d'échange modbus similaire pour les adresses de type température , electrolyse , pH ...
